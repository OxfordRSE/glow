...
export const contractExamplesData = [
  ...
  },
  {
    ...
    response: {
      ...
      school_ids: [1],
      school_names: ["Focus School Academy"],
      is_active: true,
      is_admin: false,
    },
  },
  {
    ...
    response: {
      access_token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyQGV4YW1wbGUuY29tIiwiZXhwIjoxNzE2MjQwMDAwfQ.fake_signature",
      token_type: "bearer",
    },
  },
  {
    ...
    response: [
      {
        ...
        geographical_neighbor_ids: [2],
        statistical_neighbor_ids: [2, 3],
        query_options: {
          variables: [
            "bw_wbeing_1",
            "bw_wbeing_2",
      ...
      },
      {
        ...
        size: "large",
        category: "academy",
        geographical_neighbor_ids: [1],
        statistical_neighbor_ids: [1, 3],
        query_options: {
          variables: [
            "bw_wbeing_1",
            "bw_wbeing_2",
