...
export const createSuppressedFocusHandler = () => {
  console.warn('createSuppressedFocusHandler is deprecated. Use contract examples instead.')
...
export const createSuppressedNeighborHandler = () => {
  console.warn('createSuppressedNeighborHandler is deprecated. Use contract examples instead.')
...
export const createErrorHandler = () => {
  console.warn('createErrorHandler is deprecated. Use contract examples instead.')
  return exampleHandlers[0]
}
