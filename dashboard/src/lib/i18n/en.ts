...
export const en = {
  ...
  explore: {
    ...
    multipleCompatibleVersionsNote: "Data come from multiple compatible versions of the same questionnaire.",
    rescaledValuesNote: "Some values have been rescaled to allow comparison between form versions.",
  ...
  api: {
    ...
    phq9_9: "PHQ-9: Thoughts that you would be better off dead or of hurting yourself",
